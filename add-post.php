    ...
    <div class="container-xxl bg-white p-5">
        ...
        <form action="" method="post" class="card add-post-user-spacing" enctype="multipart/form-data" novalidate>
            ...
            <div class="mb-3">
                ...
                <textarea name="post_content" value="<?php echo $post_content; ?>" class="form-control <?php echo !empty($contentErr) ? "is-invalid" : "" ?>" id="validationContent" placeholder="Enter description" required></textarea>
                <div  class="invalid-feedback">
                <?php echo $contentErr; ?>
                </div>
            </div>
