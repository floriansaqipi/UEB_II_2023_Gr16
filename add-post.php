    ...
    <div class="container-xxl bg-white p-5">
        <div class="main-header" style="margin-top: 0px;">
            ...
            <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                ...
                <li class="breadcrumb-item path__spacing"><a href="add-post.php">/ Add a Post</a>
                </li>
            </ol>
            <div class="col-12 header__go-back-button">
                <a class="btn btn-primary mx-2" href="userprofile.php" role="button"><i class="bi bi-skip-backward-fill"></i> &nbsp; Go Back</a>
            </div>

        </div>
        <?php insertPostRegular()?>
        ...
        <form action="" method="post" class="card add-post-user-spacing" enctype="multipart/form-data" novalidate>
            ...
            <div class="mb-3">
                ...
                <textarea name="post_content" value="" class="form-control <?php echo !empty($contentErr) ? "is-invalid" : "" ?>" id="validationContent" placeholder="Enter description" required><?php echo $post_content; ?></textarea>
                <div  class="invalid-feedback">
                <?php echo $contentErr; ?>
                </div>
            </div>
            <div class="mb-3">
                <button class="btn btn-primary" type="submit" name="add-post">Post</button>
            </div>
