...
--
-- Host: localhost:3307
-- Generation Time: May 14, 2023 at 09:37 PM
...
(14, 3, 'asfsdfasd', 'asdfasdfasf', 1, '2023-05-14');
...
INSERT INTO `users` (`user_id`, `username`, `password`, `firstname`, `lastname`, `email`, `image`, `is_admin`) VALUES
(3, 'test', 'test1234', 'test', 'test', 'test@test.com', 'profile.jpg', 1);
