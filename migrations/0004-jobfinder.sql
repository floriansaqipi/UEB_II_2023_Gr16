...
INSERT INTO `users` (`user_id`, `username`, `password`, `firstname`, `lastname`, `email`, `image`, `cover_image`, `is_admin`, `bio`, `about`) VALUES
(3, 'test', 'test1234', 'test', 'test', 'test@test.com', 'profile.jpg', 'cover_default.jpg', 0, 'web dev', 'also like programming'),
(4, 'test1', 'test1234', 'test', 'test', 'test1@test.com', 'profile.jpg', 'cover.jpg', 1, 'web', 'i like programming');
